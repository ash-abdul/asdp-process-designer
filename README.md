...
> **Phase 2 V0–V3, V4a, V4b-core and V5 accepted · V6 implemented, awaiting review** · V4b-eval deferred (blocked by H3) · V2-PDF blocked on spike S2
...
> by us rather than asserted by a model, and structured requirement **proposals** that are always
> draft and always cite verified evidence. **713 tests pass, none skipped.**

...
| [v6-proposal.md](60-plan/v6-proposal.md) | V6 boundary — canonicalisation, conflict **candidates**, deterministic precedence, reconciliation. **PROPOSED, NOT APPROVED.** Decisions **Q1–Q9** |

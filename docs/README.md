...
| [v6-proposal.md](60-plan/v6-proposal.md) | V6 boundary — canonicalisation, conflict **candidates**, deterministic precedence, reconciliation. **APPROVED 2026-08-23.** Decisions **Q1–Q9** |

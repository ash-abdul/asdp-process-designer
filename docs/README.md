...
| [u3-proposal.md](60-plan/u3-proposal.md) | **U3 boundary — the requirements workspace.** List, detail, evidence pane, the four review actions, revision, human-originated L3, and human evidence recording. **BOUNDARY APPROVED 2026-08-26 (Z1–Z14); NOT YET IMPLEMENTED.** **Z2-B**: `apps/web` gets **no AI-invoking control**. **Z6-B**: the edit-rate observation is reported with its caveat and **limitation 70 stays open**. **G-a and G-e are deliberately unfilled**, so flags and version history are out |

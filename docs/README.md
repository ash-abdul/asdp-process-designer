...
> **Status:** Phase 0 approved · Phase 1 complete · **Phase 2 V0–V3, V4a, V4b-core and V5 accepted; V6 implemented** · **Version:** 2.5 · **Updated:** 2026-08-23
...
| [v6-proposal.md](60-plan/v6-proposal.md) | V6 boundary — canonicalisation, conflict **candidates**, deterministic precedence, reconciliation. **APPROVED 2026-08-23; implemented, awaiting review.** Decisions **Q1–Q9** |

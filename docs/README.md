...
| [ui-design-foundation-proposal.md](60-plan/ui-design-foundation-proposal.md) | **UI/UX design foundation boundary — shell, tokens, components, semantic states, evidence and AI presentation, accessibility, RTL, and the governed **Ask ASDP** contextual assistant's UX architecture.** Requested by **F-U2-b** before U3. **PROPOSED — NOT APPROVED.** Decisions **Y1–Y28**; smallest implementation boundary proposed as **D-U2.5**. The assistant is **design only** — implementing it needs **H3** |
